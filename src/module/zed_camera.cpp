...
std::vector<std::string> Zed2i::validate(viam::sdk::ResourceConfig /*cfg*/) {
  return {};
}
...
std::vector<viam::sdk::GeometryConfig> Zed2i::get_geometries(const viam::sdk::ProtoStruct& /*extra*/) {
  return {};
}
